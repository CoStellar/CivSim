...
public class Simulation implements Runnable {
    ...
    public void run() {
        ...
        try {
            new Winner(writePopulation());
        } catch (IOException | FontFormatException e) {
            throw new RuntimeException(e);
        }
    }

    private void createPositionsFile() throws IOException {
        ...
        for (int i = 0; i < mapSize.getMapSize() * mapSize.getMapSize(); i++) {
    ...
    private void createDataSheet() throws IOException {
    ...
    private void createPopulationSheet() throws IOException {
    ...
    private String[] writePopulation() {
    ...
    private void  updateMilitaryUnits(){
